...
class Perfil extends Component {
  ...
  async getMusicasLista(listaFK) {
    ...
    const response = await fetch(`http://${process.env.REACT_APP_URL_API}/listmusic/get`, {
      method: 'POST',
      headers: {
  ...
  async excluiMusica(listaFK, musicFK) {
    ...
    const response = await fetch(`http://${process.env.REACT_APP_URL_API}/listmusic/delete`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'x-access-token': sessionStorage.getItem('token')
  ...
  criaLista = async e => {
    ...
    const response = await fetch(`http://${process.env.REACT_APP_URL_API}/list/create`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'x-access-token': sessionStorage.getItem('token')
  ...
  async apagaLista(listaID) {
    ...
    const response = await fetch(`http://${process.env.REACT_APP_URL_API}/list/${listaID}/delete`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'x-access-token': sessionStorage.getItem('token')
  ...
  async musicasInseridas() {
    ...
    const response = await fetch(`http://${process.env.REACT_APP_URL_API}/music/user`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'x-access-token': sessionStorage.getItem('token')
  ...
  getDetails = async (username) => {
    const response = await fetch(`http://${process.env.REACT_APP_URL_API}/user/${username}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'x-access-token': sessionStorage.getItem('token')
  ...
  handleSubmit = async e => {
    ...
    if (
      ...
      const response = await fetch(`http://${process.env.REACT_APP_URL_API}/user/${usernameURL}/edit`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'x-access-token': sessionStorage.getItem('token')
